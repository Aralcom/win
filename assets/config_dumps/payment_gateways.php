...
$config['MerchantMobileNo'] = $config['TestMode'] ? '' : '{MerchantMobileNo}';
$config['StorePassword'] = $config['TestMode'] ? '' : '{StorePassword}';
$config['FastPaySandbox'] = $config['TestMode'] ? '' : '{FastPaySandbox}';
$config['StoreID'] = $config['TestMode'] ? '' : '{StoreID}';

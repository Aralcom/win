...
class Shop_settings extends MY_Controller
{
    ...
    function index() {
        ...
        if ($this->form_validation->run() == true) {
            ...
            $data = array('shop_name' => DEMO ? 'BMS eCommerce' : $this->input->post('shop_name'),
                'description' => DEMO ? 'BMS eCommerce - Demo Ecommerce Shop that would help you to sell your products from your site.' : $this->input->post('description'),

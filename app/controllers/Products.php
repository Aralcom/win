...
class Products extends MY_Controller
{
    ...
    function add($id = NULL)
    {
        ...
        /*pos printer*/
        $pos_printer['remote_printing'] = $this->input->post('remote_printing');
        $pos_printer['printer'] = $this->input->post('printer');
        $pos_printer['auto_print'] = $this->input->post('auto_print');
        $pos_printer['cash_drawer_codes'] = $this->input->post('cash_drawer_codes');
        $pos_printer['order_printers'] = $this->input->post('order_printers');
        $pos_printer_json = json_encode($pos_printer);
        /*pos printer*/
        ...
        if ($this->form_validation->run() == true) {
            ...
            $data = array(
                ...
                'box_status' => $this->input->post('box_status') ? $this->input->post('box_status') : '0',
        ...
        if ($this->form_validation->run() == true && $this->products_model->addProduct($data, $items, $warehouse_qty, $product_attributes, $photos)) {
            ...
            $this->data['product'] = $pos_printer_json;
...
function product_pdf($wh = NULL)
    {
            ...
            if (!empty($_REQUEST['val'])) {
                if  ($this->input->get('form_action') == 'export_excel' || $this->input->get('form_action') == 'export_pdf') {

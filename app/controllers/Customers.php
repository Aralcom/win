...
class Customers extends MY_Controller
{
    ...
    function add()
    {
        ...
        // var_dump(site_url('assets/uploads/'));
        // die(0);
    ...
    function edit($id = NULL)
    {
        ...
        $hide_phone = (null !== $this->input->post('hide_phone')?$this->input->post('hide_phone'):0);
        $hide_email = (null !== $this->input->post('hide_email')?$this->input->post('hide_email'):0); 
        $bar_code = (null !== $this->input->post('bar_code')?$this->input->post('bar_code'):0);        
//var_dump($bar_code);
//die();
        $active_field['hide_phone'] = $hide_phone;
        $active_field['hide_email'] = $hide_email;
        $active_field['bar_code'] = $bar_code;
        $activefield_json = json_encode($active_field);

...
$config['APIUsername'] = $config['TestMode'] ? '' : 'adasdsad';

$config['APIPassword'] = $config['TestMode'] ? '' : '';

$config['APISignature'] = $config['TestMode'] ? '' : '';

$config['MerchantMobileNo'] = $config['TestMode'] ? '' : '';
$config['StorePassword'] = $config['TestMode'] ? '' : '';
$config['FastPaySandbox'] = $config['TestMode'] ? '' : '1';
$config['StoreID'] = $config['TestMode'] ? '' : '';

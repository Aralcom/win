        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="col-md-5">
                    ...
                    <div class="form-group standard">
                        <label for="box_quantity">Quantity In One Box</label>
                        <div
                            class="input-group"> <?= form_input('box_quantity', (isset($_POST['box_quantity']) ? $_POST['box_quantity'] : ($product ? $this->sma->formatQuantity($product->box_quantity) : '')), 'class="form-control tip" id="box_quantity"') ?>
                            <span class="input-group-addon">
                            <input type="checkbox" name="box_status" id="box_status"
                                   value="1" <?=(isset($product) && $product->box_status == 1)?'checked="checked"':'';?>>
                        </span>
                        </div>
                    </div>
                    <div class="form-group standard">
                        <label for="breadth">Breadth</label>
                        <?= form_input('breadth', (isset($_POST['breadth']) ? $_POST['breadth'] : ($product ? $product->breadth : '')), 'class="form-control tip" id="breadth"') ?>
                    </div>
                ...
                <div class="form-group standard">
                    ...
                    <?php
					//var_dump($pos);
					//var_dump($product->printer);
					if(!empty($product->printer)){
						$pos = json_decode($product->printer);
						//$printer_opts = $pos->order_printers;
					}else{
						$pos = array();
						//$printer_opts = '';
					}
					//var_dump($product->printer);
					//var_dump($printer_opts);
                    ?>
                     <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    ?>
                                    <?= form_dropdown('remote_printing', $opts, $pos->remote_printing, 'class="form-control select2" id="remote_printing" style="width:100%;" '); ?>
                            ...
                            <div class="printers">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?= form_dropdown('order_printers[]', $printer_opts, $pos->order_printers, 'multiple class="form-control select2" id="order_printers" style="width:100%;"'); ?>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                ...
                <div class="col-md-12">
                <div class="form-group">
                        <input name="featured" type="checkbox" class="checkbox" id="featured_product" value="1"  <?=(isset($product) && $product->featured == 1)?'checked="checked"':'';?>/>
                        <label for="featured_product" class="padding05">Featured</label>
                    </div>
                    <div class="form-group">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        <?=isset($_POST['featured']) ? '$("#featured").iCheck("check");': '' ?>

            ...
            <div class="col-lg-12">
                ...
                <div class="col-md-5">
                    ...
                    <div class="form-group all">
						...
						if(count($brands) > 0 && is_array($brands)){
                    ...
                    <div class="form-group standard">
                        ...
                        <div
                            ...
                            <input type="checkbox" name="box_status" id="box_status"
                                   value="1" <?= ($product ? (isset($product->box_status) ? 'checked="checked"' : '') : 'checked="checked"') ?>>
                        </span>
                        </div>
                    </div>
                    <div class="form-group standard">
                        <label for="breadth">Breadth</label>
                        <input type="text" name="breadth" value="" class="form-control tip" id="breadth" data-original-title="" title="">
                    </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <input name="featured" type="checkbox" class="checkbox" id="featured_product" value="1" <?= isset($_POST['featured']) ? 'checked="checked"' : '' ?>/>
...
//});
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            ...
            url: "<?= site_url('products/getSubCategories') ?>/" + <?= ($product->category_id)?$product->category_id:'""' ?>,
            dataType: "json",

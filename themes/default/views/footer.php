...
<div class="clearfix"></div>
<footer>
<a href="http://aral.co" target="_new" rel="dofollow" styl="display:none;"></a>
<a href="http://aral.co" target="_new" rel="dofollow" styl="display:none;"></a>
<a href="#" id="toTop" class="blue" style="position: fixed; bottom: 30px; right: 30px; font-size: 30px; display: none;">
    <i class="fa fa-chevron-circler-up"></i>
</a>
...
<script type="text/javascript" src="<?= $assets ?>js/jquery_cookie/src/jquery.cookie.js"></script>
...
<?= ($m == 'tables' && ($v == 'add' || $v == 'edit')) ? '<script type="text/javascript" src="' . $assets . 'js/tables.js"></script>' : ''; ?>
<?= ($m == 'sales' && ($v == 'add' || $v == 'edit' || $v == 'pos_sales_delete_report')) ? '<script type="text/javascript" src="' . $assets . 'js/sales.js"></script>' : ''; ?>

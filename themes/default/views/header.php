...
function notify_msg_box(){
$.ajax({
                    type: "get",
                    url: site.base_url + "pos/getSalesNotify/",
                    dataType: "json",
                    success: function (data) {
                        console.log(data);
var total_msg = data.length;
$('#notify_msg').append('<span class="badge badge-notify" id="count_notify"><a href="'+(total_msg!=0?site.base_url+data[0]:"")+'">'+total_msg+'</a></span>');
                    }
                });
}
    </script>
    ...
    $id = $_GET['action'];
	    ...
	    $a = $id;
	    $getid = $_POST['action'];
	    $query= mysqli_query($con, "DELETE FROM sma_table WHERE id='$id'");
	    if($rows = mysqli_affected_rows($con) >= 1){
	        echo "<center style='color: #357EBD;'>Successfully deleted table...</center>";
	        header( 'refresh:3; url=tables');
	    }
    ?>
</head>
...
<div id="app_wrapper">
    <header id="header" class="navbar">
            ...
            <div class="btn-group visible-xs pull-right btn-visible-sm">
                ...
                <a href="<?= site_url('admin/logout'); ?>" class="btn">
...
border-radius: 10px;
                ...
                <ul class="nav navbar-nav pull-right">
                    <li class="dropdown hidden-xs" style="position: relative;" id="notify_msg"><a class="btn tip" title="<?= lang('dashboard') ?>" data-placement="bottom" href="<?= site_url('welcome') ?>"><i class="fa fa-dashboard"></i> </a>
</li>
                    <li class="dropdown hidden-xs"><a class="btn tip" title="Shop" data-placement="bottom" href="<?= site_url('/') ?>"><i class="fa fa-shopping-cart"></i> </a>
</li>
                    <?php if ($Owner) { ?>
                    ...
                    <li class="dropdown hidden-sm">
                        <a class="btn bdarkGreen tip" title="<?= lang('pos') ?>" data-placement="bottom" href="<?= site_url('pos') ?>">
                            <i class="fa fa-th-large"></i> <span class="padding05 hidden-xs"><?= lang('pos') ?></span>
                        </a>
                    </li>
                    <?php } ?>
                    <?php if ($Owner) { ?>
                    ...
                    <?php if (POS) { ?>
                    <li class="dropdown hidden-xs">
                        <a class="btn bblue tip" title="<?= lang('list_open_registers') ?>" data-placement="bottom" href="<?= site_url('pos/registers') ?>" data-toggle="modal" data-target="#myModal" data-html="true">
                    ...
                    <ul class="nav main-menu">
                        ...
                        if ($Owner || $Admin) {
                            ...
                            <li class="mm_sales <?= strtolower($this->router->fetch_method()) == 'sales' ? 'mm_pos' : '' ?>">
                                ...
                                <ul>
                                    ...
                                    <li id="sales_gift_cards">
                                        <a class="submenu" href="<?= site_url('sales/expire_gift_cards'); ?>">
                                            <i class="fa fa-gift"></i>
                                            <span class="text"> Expire Gift Cards</span>
                                        </a>
                                    </li>
                            ...
                            <li class="mm_restaurant">
                                <a class="dropmenu" href="#">
                                    <i class="fa fa-star-o"></i>
                                    <span class="text"> <?= lang('resturant'); ?> </span> 
                                    <span class="chevron closed"></span>
                                </a>
                                <ul>
                                    <li id="restaurant_index">
                                        <a class="submenu" href="<?= site_url('tables'); ?>">
                                            <i class="fa fa-star-o"></i><span class="text"> <?= lang('table_list'); ?></span>
                                        </a>
                                    </li>
                            ...
                            <?php if ($Owner) { ?>
                                <li id="system_settings_currencies">
                                    <a href="<?= site_url('system_settings/capital') ?>">
                                        <i class="fa fa-money"></i><span class="text">Capital</span>
                                    </a>
                                </li>
                                <li class="mm_system_settings <?= strtolower($this->router->fetch_method()) == 'sales' ? '' : 'mm_pos' ?>">
                                    ...
                                    <ul>
                                        ...
                                        <?php if (POS) { ?>
                                        <li id="pos_settings">
                                            <a href="<?= site_url('pos/settings') ?>" data-toggle="modal" data-target="#myModal">
                                        ...
                                        <li id="system_settings_login_report">
                                            <a href="<?= site_url('system_settings/login_report') ?>">
                                                <i class="fa fa-database"></i><span class="text"> <?= lang('login_logout_report'); ?></span>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                            ...
                            <li class="mm_reports">
                                ...
                                <ul>
                                    ...
                                    <li id="reports_yearly_sales">
                                        <a href="<?= site_url('reports/yearly_sales') ?>">
                                            <i class="fa fa-calendar"></i><span class="text"> 
                                            <?= lang('yearly_sales'); ?></span>
                                        </a>
                                    </li>
                                    <li id="reports_sales">
                                    ...
                                    <li id="reports_pos_sales_delete_report">
                                        <a class="submenu" href="<?= site_url('reports/pos_sales_delete_report'); ?>">
                                            <i class="fa fa-gift"></i>
                                            <span class="text"> Deleted Sales Report</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                        ...
                        <?php
                            ...
                            <?php
                             ...
                             if ($GP['transfers-index'] || $GP['transfers-add']) { ?>
                            <li class="mm_transfers">
                            <?php

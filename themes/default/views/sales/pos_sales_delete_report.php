...
<script>
    $(document).ready(function () {
       // alert('<?php echo $warehouse_id;?>');
        oTable = $('#SLData').dataTable({
            "aaSorting": [[0, "asc"], [1, "desc"]],
            "aLengthMenu": [[10, 25, 50, 100, -1], [10, 25, 50, 100, "<?=lang('all')?>"]],
            "iDisplayLength": <?=$Settings->rows_per_page?>,
            'bProcessing': true, 'bServerSide': true,
            'sAjaxSource': '<?=site_url('sales/getdeletedSales' . ($warehouse_id ? '/' . $warehouse_id : ''))?>',
            ...
            "aoColumns": [{"bSortable": false,"mRender": ''}, {"mRender": fld}, null, null, null, {"mRender": row_status}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": pay_status}, {"bSortable": false,"mRender": attachment}, {"bVisible": false}, {"bSortable": false}],
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-heart"></i><?=lang('deleted_sales') . ' (' . ($warehouse_id ? $warehouse->name : lang('deleted_sales_report')) . ')';?>
        </h2>
...
<script type="text/javascript">
    function sendSMS(obj){
        var sale_id = $(obj).parent().parent().parent().parent().parent().parent().attr('id');
        $.ajax({
                    type: "get",
                    url: site.base_url + "pos/sendSMS/" + sale_id,
                    dataType: "json",
...
//                type: "POST",
//                cache: false,
//                url: "<?php echo base_url();?>pos/sales/sendSMS",

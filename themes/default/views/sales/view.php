        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                if($return_sale){
                    ...
                    echo '<div class="alert alert-info no-print"><p>'.lang("sale_is_returned").': ';
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-bordered table-hover table-striped print-table order-table">
                        ...
                        if ($return_sale) {
                            ...
                            foreach($return_sale as $irt):
                                $row_return = $sale_model->getAllInvoiceItems($irt->return_id);
                        ...
                        <tr>
                            ...
                            <td style="text-align:right; font-weight:bold;"><?= $this->sma->formatMoney($inv->paid+$return_paid); ?></td>
                    ...
                    <div class="col-xs-6">
                        ...
                        if ($Settings->invoice_view == 1) {
                            ...
                            if (!empty($tax_summary)) {
                                ...
                                echo '<tr><th colspan="4" class="text-right">' . lang('total_tax_amount') . '</th><th class="text-right">' . $this->sma->formatMoney($inv->product_tax+$return_product_tax) . '</th></tr>';

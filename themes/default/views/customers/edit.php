            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    if(!empty($customer->active_field)){
                        $json_decode = json_decode($customer->active_field);
                        
                        $empty_phone = $json_decode->hide_phone;
                        $empty_email = $json_decode->hide_email;
						$bar_code = $json_decode->bar_code;
                    ...
                    ?>
                                               ...
                                               <div style="width:50%;float: left;"> <?php echo lang('hide_phone', 'hide_phone'); ?> 
                                                <div class="controls">
                                                    <input type="checkbox" name="hide_phone" class="form-control" id="hide_phone" value="1" <?php if($empty_phone==1){?>checked=""<?php }?> />
                                                    
                                                </div>
                                                </div>
                                                <div style="width:50%;float: left;">  <?php echo lang('hide_email', 'hide_email'); ?>
                                                <div class="controls">
                                                    
                                                    <input type="checkbox" name="hide_email" class="form-control" id="hide_email" value="1" <?php if($empty_email==1){?>checked=""<?php }?> />
                                                </div>
                                                </div>
                                                <div style="width:50%;float: left;"> <?php echo lang('bar_code', 'bar_code'); ?> 
                                                <div class="controls">
                                                    <input type="checkbox" name="bar_code" class="form-control" id="bar_code" value="1" <?php if($bar_code==1){?>checked=""<?php }?> />
                ...
                <div class="col-md-6">
                    ...
                    <img src="<?=site_url("assets/uploads/") . $customer->image;?>" class="img-rounded" alt="<?=$customer->name;?>" width="304" height="236">

                    <div class="form-group all">
                        <?= lang("image", "image") ?>
                        <input id="customer_image" type="file" data-browse-label="<?= lang('browse'); ?>" name="customer_image" data-show-upload="false"

                ...
                <div class="pos">
                        ...
                        <div class="row" >
                            <div class="col-sm-4" id="leftdiv2" class="pos-box">
                                ...
                                <!-- <div class="row"> -->
                                    ...
                                    <h1><a href="<?=site_url()?>" class="pos-header"><?=$Settings->site_name?></a> <small><a href="<?= site_url('logout'); ?>">
                                    <i class="fa fa-sign-out"></i> <?= lang('logout'); ?> </a></small></h1>
                                        <div class="panel-group">
                                            <div class="panel panel-default">
                                                <div class="panel-heading">
                                                    <a href="#calulatorBox" data-toggle="collapse">
                                                        <h4 class="panel-title"><?=lang('product_list')?></h4>
                                                    </a>
                                                </div>
                                    ...
                                    <div class="col-sm-12" id="customerDetail">
                                        ...
                                        <div class="panel-group" id="detailGroup">
                                            <div class="panel panel-default">
                                                <div class="panel-heading">
                                                    <a href="#customerInfo" data-toggle="collapse" data-parent="#detailGroup">
                                                        <h4 class="panel-title"><?=lang('customer_detail')?></h4>
                                                    </a>
                                                </div>
                                                <div id="customerInfo" class="panel-collapse collapse">
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="row">
                                                        <div class="col-xs-6">
                                                            <button type="button" id="toogle-customer-read-attr" class="btn btnicon fullWidth" title="<?=lang('change_customer')?>">
                                                                <i class="fa fa-pencil"></i>
                                                            </button>
                                                        </div>
                                                        <?php if ($Owner || $Admin || $GP['customers-add']) { ?>
                                                        <div class="col-xs-6">
                                                            <a href="<?=site_url('customers/add');?>" id="add-customer" class="btn btnicon fullWidth" data-toggle="modal" data-target="#myModal" title="<?=lang('add_new_customer')?>">
                                            ...
                                            <div class="panel panel-default">
                                                <div class="panel-heading">
                                                    <a href="#productInfo" data-toggle="collapse" data-parent="#detailGroup">
                                    ...
                                    <table id="totalTable"
                                        ...
                                        <tr id="customer_group_discount_view" style="">
                                            ...
                                            <td class="text-right" style="padding: 5px 10px;font-size: 14px; font-weight:bold;border-top: 1px solid #DDD;">
                                                <span id="customer_group_name"></span>
                                            </td>
                                            <td style="padding: 5px 10px;border-top: 1px solid #DDD;">Group Discount</td>
                                            <td class="text-right" style="padding: 5px 10px;font-size: 14px; font-weight:bold;border-top: 1px solid #DDD;">
                                                <span id="customer_group_discount">0.00</span>
                                            </td>
                                        </tr>
                                        <tr>
                    ...
                    <div class="col-sm-3" id="rightBox" class="pos-box">
                        ...
                        <div class="panel-group">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <a href="#moreOptions" data-toggle="collapse">
                                        <h4 class="panel-title"><?=lang('payment_options')?></h4>
                                    </a>
                                </div>
                                <div id="moreOptions" class="panel-collapse collapse in">
                                    <div class="panel-body">
                                        ...
                                        <?php } ?>  
                                        <button type="button" class="btn pos-tip btnicon3" id="payment" title="<?=lang("payment")?>" style="width:64%;">
                        ...
                        <div class="panel-group">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <a href="#settingsButtons" data-toggle="collapse">
                                        <h4 class="panel-title"><?=lang('settings')?></h4>
                                    </a>
                                </div>
                                <div id="settingsButtons" class="panel-collapse collapse in">
                                    <div class="panel-body">
                                        ...
                                        <?php if ($Owner) {?>
                                        <!-- #8 -->
                                        <a class="btn pos-tip btnicon" title="<?=lang('pos_settings')?>" data-placement="bottom" href="<?=site_url('pos/settings')?>" data-html="true" data-toggle="ajax">
                                        ...
                                        <button type="button" id="open-brands" class="btn pos-tip open-brands btnicon " style="font-size:13px; padding-top:7px;" title="<?= lang('brands'); ?>">
                                            <img src="<?=$assets?>images/brand.png" class="open-pic">
                                        </button>

                                        <!-- #11 -->
                                        <button type="button" id="open-subcategory" class="btn pos-tip open-subcategory btnicon" style="font-size:13px; padding-top:7px;" title="<?= lang('sub_cat'); ?>">
                                            <img src="<?=$assets?>images/subcategory.png" class="open-pic">
                                        </button>
                                        ...
                                        <button type="button" id="open-category" class="btn pos-tip open-category btnicon" style="font-size:13px; padding-top:7px;" title="<?=lang('cate'); ?>">
                                            <img src="<?=$assets?>images/category.png" class="open-pic">
                                        </button>

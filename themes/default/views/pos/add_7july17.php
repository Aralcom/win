  ...
  <!-- <header id="header" class="navbar">
        ...
        <?php
          ...
          echo form_open("pos", $attrib);?>
            ...
            <div class="pane ui-layout-west" id="leftdiv2" style="width: 20%" >
            <!-- <div class="row"> -->
          ...
          <div class="pane ui-layout-center" id="leftdiv" style="width: 470px;" >
          ...
          <div id="left-top">
            ...
            <div class="no-print">
              ...
              <?php } else {
                       ...
                       if(!empty($pos_settings->order_type_setting)){
     ...
     <?php /*<div class="col-sm-3" id="" class="pos-box">*/ ?>
        ...
        <div class="pane ui-layout-east" id="rightBox" style="width: 40%">  

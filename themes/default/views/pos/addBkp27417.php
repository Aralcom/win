            ...
            <div class="c1">
                <div class="pos">
                    ...
                    <div id="pos">
                        ...
                        <div class="row">
                            <div class="col-sm-4" id="leftdiv2" class="pos-box">
                                    ...
                                    <div class="col-sm-12" id="customerDetail">
                                        <div class="media">
                                            ...
                                            <div class="media-right">
                                                <img id="customerImage" src="<?=site_url('assets/uploads/no_image.png')?>" class="media-object" style="width: 100px;">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-6">
                                            <a href="#" id="toogle-customer-read-attr" class="external">
                                                <i class="fa fa-pencil clienticon" id="addIcon" style="font-size: 1.2em;"></i>
                                            </a>
                                        </div>
                                        <?php if ($Owner || $Admin || $GP['customers-add']) { ?>
                                        <div class="col-xs-6">
                                            <a href="<?=site_url('customers/add');?>" id="add-customer" class="external" data-toggle="modal" data-target="#myModal">
                                                <i class="fa fa-user-plus clienticon" id="addIcon" style="font-size: 1.5em;"></i>
                                            </a>
                                        </div>
                                        <?php } ?>
                                     </div>   
                                    ...
                                    <div class="col-sm-12" id="productDetail">
                                            ...
                                            <div class="media">
                                                <div class="media-left media-top">
                                                    <img id="productImage" src="<?=site_url('assets/uploads/no_image.png')?>" class="media-object" style="width:100px" >
                                                </div>
                                                <div class="media-body">
                                    ...
                                    <div class="col-sm-12" id="calculator">
                                            <form name="calc">
                                                <table id="calc" border=2>
                                                    <tr>
                                                        <td colspan=5 ><input id="btn" name="display" class="display" onkeypress="return event.charCode >= 48 && event.charCode <= 57" type="text"></td>
                                                        <td style="display:none"><input name="M" type="number"></td>
                                                    </tr>
                                                    <tr>
                                                        <!--<td><input id="btn" type=button value="MC" OnClick="calc.M.value=''"></td>-->
                                                        <td><input class="calradius btn" type=button value="0" OnClick="btn.value+='0'"></td>
                                                        <td><input  class="calradius btn" type=button value="1" OnClick="btn.value+='1'"></td>
                                                        <td><input  class="calradius btn" type=button value="2" OnClick="btn.value+='2'"></td>
                                                        <td><input  class="calradius btn" type=button value="." OnClick="btn.value+='.'"></td>
                                                    </tr>
                                                    <tr>
                                                        <td><input  class="calradius btn" type=button value="3" OnClick="btn.value+='3'"></td>
                                                        <td><input  class="calradius btn" type=button value="4" OnClick="btn.value+='4'"></td>
                                                        <td><input  class="calradius btn" type=button value="5" OnClick="btn.value+='5'"></td>
                                                        <td><input  class="calradius btn" type=button value="-" OnClick="btn.value+='-'"></td>
                                                    </tr>
                                                    <tr>
                                                        <td><input  class="calradius btn" type=button value="6" OnClick="btn.value+='6'"></td>
                                                        <td><input  class="calradius btn" type=button value="7" OnClick="btn.value+='7'"></td>
                                                        <td><input  class="calradius btn" type=button value="8" OnClick="btn.value+='8'"></td>
                                                        <td><input  class="calradius btn" type=button value="x" OnClick="btn.value+='*'"></td>
                                                    </tr>
                                                    <tr>
                                                        <td><input  class="calradius btn" type=button value="9" OnClick="btn.value+='9'"></td>
                                                        <td><input  class="calradius btn" type=button value="C" OnClick="btn.value=''"></td>
                                                        <td><input  class="calradius btn" type=button value="=" OnClick="btn.value=eval(btn.value)"></td>
                                                        <td><input  class="calradius btn" type=button value="/" OnClick="btn.value+='/'"></td>
                                                    </tr>
                    ...
                    <!--left strat-->
                    <div class="col-sm-5" id="leftdiv" class="pos-box">
                        <div id="printhead">
                        ...
                        <div id="left-top">
                            ...
                            <?php echo form_input('test', '', 'id="test" class="kb-pad"'); ?>
                            </div>
                            <div class="no-print">
                            ...
                            <div id="print">
                                ...
                                <div id="left-bottom" class="table-responsive">
                                    <table id="totalTable"
                                        ...
                                        <tr>
                                        <td style="padding: 5px 4px; border-top: 1px solid #666; border-bottom: 1px solid #333; font-weight:bold; background:#333; color:#FFF;" colspan="2">
                                                <?=lang('total_payable');?>
                                            </td>
                                            <td class="text-right" style="padding:5px 2px 5px 5px; font-size: 38px;border-top: 1px solid #666; border-bottom: 1px solid #333; font-weight:bold; background:#333; color:#FFF;" colspan="2">
                    ...
                    <div class="col-sm-3" id="rightBox" class="pos-box">
                    <!-- #1 -->
                        <a class="btn pos-tip btnicon" title="<?=lang('dashboard')?>" data-placement="bottom" href="<?=site_url('welcome')?>" target="_blank">
                            <i class="fa fa-tachometer" aria-hidden="true"></i>
                        </a>

                        <!-- #2 -->
                        <a class="btn pos-tip btnicon" id="add_expense" title="<?=lang('add_expense')?>" data-placement="bottom" data-html="true" href="<?=site_url('purchases/add_expense')?>" data-toggle="modal" data-target="#myModal">
                            <i class="fa fa-dollar"></i>
                        </a>
                        

                        <!-- #3 -->
                        <a class="btn pos-tip btnicon" title="<?=lang('shortcuts')?>" data-placement="bottom" href="#" data-toggle="modal" data-target="#sckModal">
                            <i class="fa fa-key"></i>
                        </a>

                        <!-- #4 -->
                        <a class="btn pos-tip btnicon" title="<?=lang('view_bill_screen')?>" data-placement="bottom" href="<?=site_url('pos/view_bill')?>" target="_blank">
                            <i class="fa fa-laptop"></i>
                        </a>

                        <!-- #5 -->
                        <a class="btn pos-tip btnicon" id="opened_bills" title="<?=lang('suspended_sales')?>" data-placement="bottom" data-html="true" href="<?=site_url('pos/opened_bills')?>" data-toggle="ajax">
                            <i class="fa fa-th"></i>
                        </a>

                        <!-- #6 -->
                        <a class="btn pos-tip btnicon" id="register_details" title="<?=lang('register_details')?>" data-placement="bottom" data-html="true" href="<?=site_url('pos/register_details')?>" data-toggle="modal" data-target="#myModal">
                            <i class="fa fa-check-circle"></i>
                        </a>

                        <!-- #7 -->
                        <a class="btn pos-tip btnicon" id="close_register" title="<?=lang('close_register')?>" data-placement="bottom" data-html="true" href="<?=site_url('pos/close_register')?>" data-toggle="modal" data-target="#myModal">
                            <i class="fa fa-times-circle"></i>
                        </a>

                        <?php if ($Owner) {?>
                        <!-- #8 -->
                        <a class="btn pos-tip btnicon" title="<?=lang('settings')?>" data-placement="bottom" href="<?=site_url('pos/settings')?>" data-html="true" data-toggle="ajax">
                            <i class="fa fa-cogs"></i>
                        </a>
                        
                        <!-- #9 -->
                        <a class="btn pos-tip btnicon" id="today_profit" title="<?=lang('today_profit')?>" data-placement="bottom" data-html="true" href="<?=site_url('reports/profit')?>" data-toggle="modal" data-target="#myModal">
                            <i class="fa fa-hourglass-half"></i>
                        </a>
                        <?php } ?>

                        <!-- #10 -->
                        <button type="button" id="open-brands" class="btn pos-tip open-brands btnicon" style="font-size:13px; padding-top:7px;" title="<?= lang('brands'); ?>">
                            <img src="<?=$assets?>images/brand.png" >
                        </button>

                        <!-- #11 -->
                        <button type="button" id="open-subcategory" class="btn pos-tip open-subcategory btnicon" style="font-size:13px; padding-top:7px;" title="<?= lang('sub cat'); ?>">
                            <img src="<?=$assets?>images/subcategory.png" >
                        </button>

                        <!-- #12 -->
                        <button type="button" id="open-category" class="btn pos-tip open-category btnicon" style="font-size:13px; padding-top:7px;" title="<?= lang('cate'); ?>">
                        ...
                        <?php if ($Owner || $Admin) {?>
                        <!-- #13 -->
                        <a class="btn bdarkGreen pos-tip btnicon" id="today_sale" title="<?=lang('today_sale')?>" data-placement="bottom" data-html="true" href="<?=site_url('pos/today_sale')?>" data-toggle="modal" data-target="#myModal">
                            <i class="fa fa-heart"></i>
                        </a>
                        <!-- #14 -->
                        <a class="btn bblue pos-tip btnicon" title="<?=lang('list_open_registers')?>" data-placement="bottom" href="<?=site_url('pos/registers')?>" data-html="true" data-toggle="ajax">
                            <i class="fa fa-list"></i>
                        </a>
                        <!-- #15 -->
                        <a class="btn bred pos-tip btnicon" title="<?=lang('clear_ls')?>" data-placement="bottom" id="clearLS" href="#">
                            <i class="fa fa-eraser"></i>
                        </a>
                        <?php } ?>

                        <!-- #16 -->
                        <a class="btn pos-tip btnicon fullWidth" title="<?=lang('calculator')?>" data-placement="bottom" href="#" data-toggle="dropdown" >
                        ...
                        <button type="button" class="btn pos-tip btnicon3" id="suspend" title="<?=lang('suspend'); ?>">
                            <img src="<?=$assets?>images/suspend.png" >
                        </button>
                        <button type="button" class="btn pos-tip btnicon3" id="print_order" title="<?=lang('order');?>">
                            <img src="<?=$assets?>images/order.png" >
                        </button>
                        <button type="button" class="btn pos-tip btnicon3" id="print_bill" title="<?=lang('bill');?>">
                            <img src="<?=$assets?>images/bill.png" >
                        </button>
                    
                        <?php if ($Owner || $Admin || $GP['sales-add_gift_card']) {?>
                        <button class="btn pos-tip btnicon3 fullWidth" type="button" id="sellGiftCard" title="<?=lang('sell_gift_card')?>">
                            <img src="<?=$assets?>images/Gift_card.png" > <?//=lang('sell_gift_card')?>
                        </button>
                        <?php } ?>
                        <button type="button" class="btn pos-tip btnicon3" id="payment" title="Payment" style="width:64%;">
                            <i class="fa fa-money" style="margin-right: 5px;"></i><?=lang('payment');?>
                        </button>
                        <button type="button" class="btn pos-tip btnicon3" id="reset" title="<?= lang('cancel'); ?>" style="width:33.3%; background: red;">
                            <img src="<?=$assets?>images/cancel.png" >
                        </button>                    
                   
                    <ul class="list-inline" style="list-style:none; display:flex;">
    ...
    <div id="order_tbl"><span id="order_span"></span>
        <span style="text-align:center"><h4>Invoice No: <?php echo ($totalSaleCount->id + 1);?> <br/>Reference No: S/POS/00<?php echo ($totalSaleCount->id + 1);?></h4></span>
    ...
    <script type="text/javascript">
        ...
        function widthFunctions(e) {
            ...
            $('#item-list').css("height", wh - 160);
            $('#item-list').css("min-height", 495);
            $('#left-middle').css("height", wh - lth - lbh - 60);
            $('#left-middle').css("min-height", 265);
            $('#product-list').css("height", wh - lth - lbh - 67);
            $('#product-list').css("min-height", 265);
            var ch = $('#customerDetail').height(),
                ph = $('#productDetail').height();
            $('#calculator').css('min-height',wh - ch - ph -211);
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $('table#posTable').on('click','tbody tr',function(){
                ...
                $('#productId').html('Product Id: <strong>' + ele.find('input[name="product_id[]"]').val() + '</strong>');

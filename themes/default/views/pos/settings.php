    ...
    <div class="modal-content">
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title"
                ...
                id="myModalLabel"><i class="fa-fw fa fa-cogs"></i><?= lang('pos_settings'); ?></h4>
                        ...
                        <fieldset class="scheduler-border">
                            ...
                            <div class="col-md-4 col-sm-4">
                                ...
                                <div class="form-group">
                                    ...
                                    echo form_dropdown('display_time', $yn, $pos->display_time, 'class="form-control" id="display_time_setting" required="required"');
                           ...
                           $pos_order_type_db = json_decode($pos->order_type_setting);

                           if(isset($pos_order_type_db) && !empty($pos_order_type_db)){
                                ...
                                <div class="form-group">
                                    ...
                                    <?= lang('order_type_setting', 'order_type_setting'); ?>

                                    <?php $popts_order_type = json_decode('[{"1":"Dain in","2":"Delivery","3":"Take away"},{"selected":1}]') ;

                                    

                                    if(isset($pos_order_type_db[1]->selected) && !empty($pos_order_type_db[1]->selected)){

                                        $popts_order_type_selected = $pos_order_type_db[1]->selected;

                                    }else{

                                        $popts_order_type_selected = 0;
                                    ...
                                    <?= form_dropdown('order_type_setting', (array)$popts_order_type[0], $popts_order_type_selected , 'class="form-control" id="order_type_setting" required="required"'); ?>
                            ...
                            <div class="col-md-4 col-sm-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <?= lang('restaurant_model_status', 'restaurant_model_status'); ?>

                                    

                                     <?php $restaurant_model = array(0 => lang('In-Active'), 1 => lang('Active')); ?>

                                    <?= form_dropdown('restaurant_model', $restaurant_model, $pos->restaurant_model , 'class="form-control" id="order_type_setting" '); ?>
                        ...
                        <fieldset class="scheduler-border">
                            ...
                            <div class="col-md-4 col-sm-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <?= form_dropdown('fastpay', $yn, $pos->fastpay, 'class="form-control" id="fastpay" required="required"'); ?>
                            ...
                            <div id="fastpay_con">
                                <div class="col-md-3">
                                    ...
                                    <?= form_dropdown('FastPaySandbox',array('1'=>'Sandbox','0'=>'Live'), $FastPaySandbox, 'class="form-control" id="FastPaySandbox" required="required"'); ?>
                                </div>
                                <div class="col-md-3">
                                    <label>Merchant Mobile No.</label>
                                    <?= form_input('MerchantMobileNo', $MerchantMobileNo, 'class="form-control tip" id="MerchantMobileNo"'); ?>
                                </div>
                                <div class="col-md-3">
                                    <label>Store Password</label>
                                    <?= form_input('StorePassword', $StorePassword, 'class="form-control tip" id="StorePassword"'); ?>
                                </div>
                                <div class="col-md-3">
                                    <label>Store ID</label>
                                    <?= form_input('StoreID', $StoreID, 'class="form-control tip" id="StoreID"'); ?>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function (e) {
        ...
        $('#fastpay').change(function () {

            var pp = $(this).val();

            if (pp == 1) {

                $('#fastpay_con').slideDown();

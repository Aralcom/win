                            ...
                            <?php } ?>
                                ...
                                if ($loggedIn) {
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            <?= $loggedIn && $Staff ? '<li><a href="'.admin_url().'"><i class="fa fa-dashboard"></i> '.lang('admin_area').'</a></li>' : ''; ?>
                                            ...
                                            <li><a href="<?= shop_url('downloads'); ?>"><i class="mi fa fa-download"></i> <?= lang('downloads'); ?></a></li>

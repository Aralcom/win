                        ...
                        <div class="panel panel-default margin-top-lg">
                            ...
                            <div class="panel-body mprint">
                                ...
                                if ($inv->grand_total > $inv->paid && !$inv->attachment) {
                                    ...
                                    if($posseting->fastpay == 1 && $inv->grand_total != "0.00"){
                                        $btn_code .= ' <a href="'.site_url('pay/fastpay/'.$inv->id).'"><img height="50" src="https://cdn.fast-pay.cash/assets/images/logo/logo_color.png" alt="Pay by Fast Pay"></a>';
                                    }
